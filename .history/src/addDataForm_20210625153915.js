                    ...
                    <div className='df-create-section'>
                        <div className='df-form-gen'>
                            ...
                            <div className="df-form-ess">
                                ...
                                <div className="df-create"><Button variant="contained" color="primary" startIcon={<CreateOutlinedIcon />}> Create </Button></div>
                                <div className="df-create"><Button variant="contained" href='' color="secondary" startIcon={<CreateOutlinedIcon />}> Discard </Button></div>
                            </div>
