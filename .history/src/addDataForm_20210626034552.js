...
class AddDataForm extends Component{
    ...
    list_it=(data,parent)=>{
        ...
        for (var c in data) {
            if(parent==="imaging_reports"){
                ro.push(this.list_to_data[parseInt(c)],1,parent));
            }
    ...
    code_box=(title,lists)=>{
        var name = `sort-sub-box ${title}`
        var box =   <div className="sort-cat">
                        <div className="sort-box">
                            <h1>{title}</h1>
                            <Divider variant='fullWidth'/>
                            <div id="sortable-1-left" className={name}>
                                lists.map((row)=>(
                                    <h2 id={}>row</h2>
                                ))
                            </div>
                        ...
                        <div className="sort-box">
                            ...
                            <Divider variant='fullWidth'/>
                            <div id="sortable-1-right" className={name}>
                            </div>
                        </div>
                    </div>
    }
