                ...
                <div className="dataform">
                    <div className='df-create-section'>
                        <div className='df-form-gen'>
                            ...
                            <div className="df-form-ess" class="flex-container1">
                                <TextField id="outlined-basic" class="flex-item1" label="Form Name" variant="outlined" /><br/>
                                <TextField id="outlined-basic-large" class="flex-item1" label="Description" variant="outlined"/>
                                <div className="df-create2" class="flex-item1"><Button variant="contained" color="primary" startIcon={<CreateOutlinedIcon />}> Create </Button></div>
                                <div className="df-create2" class="flex-item1"><Button variant="contained" href='/' color="secondary" startIcon={<CreateOutlinedIcon />}> Discard </Button></div>
                            </div>
