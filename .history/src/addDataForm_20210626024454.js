    ...
    componentDidMount(){
        ...
        new Sortable(left1, {
            group: {
                name: 's',
                // sort:true,
                // pull: 'clone',put: false // Do not allow items to be put into this list
            },
            animation: 150,
                            ...
                            <div className="df-create-section">
                                <div className="df-dnd">
                                    <div className="sort-cat">
                                        <div id="sortable-1-left" className="sort-box-1">
                                            <h1>box1 left</h1>
                                        ...
                                        <div id="sortable-1-right" className="sort-box-1">
                                            <h1>box1 right</h1>
                                        </div>
                                    </div>
                                    {/* {this.state.tree} */}
